...
JMXTRANS_LOG_LEVEL=${JMXTRANS_LOG_LEVEL:-"warn"} # [debug|info|warn|error|fatal] (default: info)

######################################
## /!\ DON'T CHANGE ANYTHING BELOW /!\
######################################
LOG_LEVEL=${JMXTRANS_LOG_LEVEL}
...
JMXTRANS_OPTS="${JMXTRANS_OPTS} -Dlog4j.configuration=file://${JMXTRANS_APP_DIR}/log4j.xml"
